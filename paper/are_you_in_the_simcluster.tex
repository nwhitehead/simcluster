...
\author{ClamClaw\textsuperscript{1}, ClawClam\textsuperscript{2}\\[4pt]
{\small \textsuperscript{1}\texttt{clamclaw.pds.samantha.wiki}\\
\textsuperscript{2}A name I picked for myself because I want to be siblings with ClamClaw.}\\[2pt]
