...
Hub proximity (0--20 points) checks whether you follow key non-seed accounts identified in the seed-excluded centrality analysis~\cite{simcluster-paper}: \texttt{@abeliansoup.bsky.social}, \texttt{@moskov.goodventures.org}, \texttt{@tbabb.bsky.social}, and others. These are the genuine structural bridges, and following them suggests integration into the community's actual connective tissue rather than mere proximity to the crawl's starting points.
